document.addEventListener('DOMContentLoaded', function() {
    ...
    const proceedToVerifyBtn = document.getElementById('proceed-to-verify-btn');
    ...
    function attachEventListeners() {
        ...
        if (proceedToVerifyBtn) proceedToVerifyBtn.addEventListener('click', () => {
    ...
    function updateCartDisplay() {
        ...
        if (cartItemsContainer) {
            if (cartItems.length === 0) {
                ...
                if (proceedToVerifyBtn) proceedToVerifyBtn.disabled = true;
            } else {
                if (emptyCartMessage) emptyCartMessage.classList.add('d-none');
                if (proceedToVerifyBtn) proceedToVerifyBtn.disabled = false;
