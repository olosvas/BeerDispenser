#!/bin/bash
cat > web_interface/static/customer.js << 'CUSTOMERJS'
        ...
        beverageTypeOptions.forEach(option => {
            option.addEventListener('click', function() {
                ...
                if (beverageTypeDisplay) {
                    const displayName = getBeverageName(type);
...
chmod +x replace_function.sh
./replace_function.sh
echo "customer.js has been replaced with clean version"
